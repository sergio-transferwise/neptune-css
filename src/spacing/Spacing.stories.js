...
storiesOf("Spacing", module).add("default", () => (
  <section id="spacing" className="wrap--content">
    <div className="bs-docs-section">
      ...
      <p className="lead">
        <span className="badge">WIP</span> Testing a existing component of TW
        Bootstrap
      </p>
      ...
      <ul>
        ...
        <li>
          <code>t</code> - for classes that set the <code>top</code> side of the
          property
        </li>
        <li>
          <code>b</code> - for classes that set the <code>bottom</code> side of
          the property
        </li>
        <li>
          <code>l</code> - for classes that set the <code>left</code> side of
          the property
        </li>
        <li>
          <code>r</code> - for classes that set the <code>right</code> side of
          the property
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <code>padding-top, padding-bottom</code> to <code>@spacer * 4</code>{" "}
          (32px)
        </li>
        <li>
          <code>5</code> - for classes that set the{" "}
          <code>margin-top, margin-bottom</code> or{" "}
          <code>padding-top, padding-bottom</code> to <code>@spacer * 5</code>{" "}
          (40px)
        </li>
      </ul>
      ...
      <h3 id="helper-classes-responsive-sections" className="bs-docs-subheader">
        Responsive sections
        <a className="anchorjs-link" href="#helper-classes-responsive-sections">
          <span className="anchorjs-icon" />
        </a>
      </h3>
      <p>
        These are the sizes of larger, responsive spacing used for separating
        sections of a page:
      </p>
      <ul>
        <li>
