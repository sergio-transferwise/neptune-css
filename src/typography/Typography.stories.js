...
storiesOf("Typography", module).add("default", () => (
  <section id="typography" className="wrap--page section">
    ...
    <p>
      ...
      <code>&lt;p&gt;</code>
      (paragraphs) receive a bottom margin of their full line-height (24px by
      default).
    </p>
    ...
    <p>
      ...
      throughout and the second is the base line-height. We use those variables
      and some simple math to create the margins, paddings, and line-heights of
      all our type and more. Customize them and Bootstrap adapts.
    </p>
    ...
    <figure className="highlight">
      <pre>
        <code className="language-html" data-lang="html">
          You can use the mark tag to <span className="nt">&lt;mark&gt;</span>
    ...
    <figure className="highlight">
      <pre>
        <code className="language-html" data-lang="html">
          <span className="nt">&lt;del&gt;</span>This line of text is meant to
          be treated as deleted text.
    ...
    <figure className="highlight">
      <pre>
        <code className="language-html" data-lang="html">
          <span className="nt">&lt;s&gt;</span>This line of text is meant to be
    ...
    <figure className="highlight">
      <pre>
        <code className="language-html" data-lang="html">
          <span className="nt">&lt;ins&gt;</span>This line of text is meant to
    ...
    <figure className="highlight">
      <pre>
        <code className="language-html" data-lang="html">
          <span className="nt">&lt;u&gt;</span>This line of text will render as
          underlined<span className="nt">&lt;/u&gt;</span>
        </code>
      </pre>
    </figure>
    ...
    <p>
      ...
      <code>&lt;small&gt;</code>
      tag to set text at 85% the size of the parent. Heading elements receive
      their own
      <code>font-size</code>
      for nested
      <code>&lt;small&gt;</code>
    ...
    <figure className="highlight">
      <pre>
        <code className="language-html" data-lang="html">
          <span className="nt">&lt;small&gt;</span>This line of text is meant to
          be treated as fine print.
