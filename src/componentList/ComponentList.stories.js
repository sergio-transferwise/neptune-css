...
storiesOf("ComponentList", module).add("default", () => (
    ...
    <div className="d-flex justify-content-between wrap--container">
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            <a href="#circles">Circles</a> <span className="badge">WIP</span>
            <span className="badge badge-primary">BT</span>
          </li>
          ...
          <li>
            <a href="#loaders">Loaders</a> <span className="badge">WIP</span>{" "}
            <span className="badge badge-primary">BT</span>
          </li>
          <li>
          ...
          <li>
            <a href="#media">Media object</a> <span className="badge">WIP</span>{" "}
            <span className="badge badge-primary">BT</span>
          </li>
          <li>
          ...
          <li>
            <a href="#process">Process</a> <span className="badge">WIP</span>{" "}
            <span className="badge badge-primary">BT</span>
          </li>
          <li>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            Colored dot <span className="badge badge-primary m-r-1">BT</span>
          </li>
          <li>
            Transformations{" "}
            <span className="badge badge-primary m-r-1">BT</span>
