...
storiesOf("Core", module).add("default", () => (
  <section id="core" className="wrap--content section">
    ...
    <figure className="highlight">
      <pre>
        <code className="language-html" data-lang="html">
          <span className="nt">&lt;p</span> <span className="na">class=</span>
    ...
    <p>
      For text that only aligns above a given break point use the appropriate
      modifier.
    </p>
    ...
    <p>
      ...
      bottom border and a help cursor on hover, providing additional context on
    ...
    <p>
      ...
      work. Preserve formatting by ending all lines with <code>&lt;br&gt;</code>
      .
    </p>
    ...
    <figure className="highlight">
      <pre>
        <code className="language-html" data-lang="html">
          {" "}
          <span className="nt">&lt;dl</span> <span className="na">class=</span>
    ...
    <div className="alert alert-info" id="callout-type-dl-truncate">
      ...
      <p>
        Horizontal description lists will truncate terms that are too long to
        fit in the left column with <code>text-overflow</code>. In narrower
        viewports, they will change to the default stacked layout.
      </p>
    </div>
    ...
    <p>
      Make terms and descriptions in <code>&lt;dl&gt;</code> line up
      side-by-side. Has to be used as single items, not in big definition lists.
